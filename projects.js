...
const PORTFOLIO_PROJECTS = [
  ...
  },
  {
    ...
    thumb: "thumbs/lexus_december_to_remember.png",
    cardTags: "broadcast",
    tags: ["general"],
    vimeo: "",
    detail: {
      bodyHTML: "<p>Case study in progress.</p>",
      media: [{ type: "image", src: "thumbs/lexus_december_to_remember.png", alt: "Lexus December to Remember" }],
      stills: [],
    },
  },
  {
    ...
    thumb: "thumbs/richards_group_holiday.png",
    cardTags: "holiday card",
    tags: ["general"],
    vimeo: "",
    detail: {
      bodyHTML: "<p>Case study in progress.</p>",
      media: [{ type: "image", src: "thumbs/richards_group_holiday.png", alt: "The Richards Group holiday card" }],
      stills: [],
    },
  },
  {
  ...
  },
  {
    ...
    thumb: "thumbs/lexus_immersive_sonic.png",
    cardTags: "experiential",
    tags: ["general", "tech"],
    vimeo: "",
    detail: {
      bodyHTML: "<p>Case study in progress.</p>",
      media: [{ type: "image", src: "thumbs/lexus_immersive_sonic.png", alt: "Lexus Immersive Sonic Challenge" }],
      stills: [],
    },
  },
  {
