Case-study stills (not homepage thumbs).
  ...
  stills/sistacade/                    → Sistacade (case-study stills)
...
JPG, WebP, or PNG. Any reasonable resolution; the grid shrinks them to fit.

Optional: detail.railHTML in projects.js for extra right-column content below stills
(e.g. additional Vimeo iframes). Not shown in the work grid; case study only.
